...
public class ProductsController {
    ...
    public Product create(@Validated @RequestBody Product product) {
        var productById =  productRepository.findByPriceAndTitle(product.getPrice(),product.getTitle());
        if (productById.isPresent()) {throw new ResourceAlreadyExistsException("Product already exists");}
